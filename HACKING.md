...
hidden if the `cdirs_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `cdirs_DEVELOPER_MODE` to the configure
...
Runs the executable target `cdirs_exe`.
